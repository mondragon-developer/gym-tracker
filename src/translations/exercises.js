/**
 * Exercise name translations from English to Spanish
 * Used for displaying exercise names in the selected language
 */
export const exerciseTranslations = {
    ...
    "Peck Deck Machine": "Máquina Peck Deck",
    ...
    "Behind-the-Neck Pulldowns": "Jalón Tras Nuca",
    ...
    "Cable Pullovers": "Pullover con Cable",
    ...
    "Press Bradford": "Press Bradford",
    "High Pulls": "Jalón Alto",
    ...
    "Cross-Body Curls": "Curl Cruzado",
    "Machine Curls": "Curl en Máquina",
    ...
    "V-Bar Pushdowns": "Extensión con Barra V",
    "Kickbacks": "Patada de Tríceps",
    "Machine Dips": "Fondos en Máquina",
    "Tate Press": "Press Tate",
    "Press Tate": "Press Tate",
    "JM Press": "Press JM",
    "Press JM": "Press JM",
    "Reverse Grip Pushdowns": "Extensión con Agarre Inverso",
    ...
    "Stiff-Leg Deadlifts": "Peso Muerto Piernas Rígidas",
    "Conventional Deadlifts": "Peso Muerto Convencional",
    "Sumo Deadlifts": "Peso Muerto Sumo",
    ...
    "Nordic Curls": "Curl Nórdico",
    "Single-Leg Deadlifts": "Peso Muerto a Una Pierna",
    "Glute-Ham Raises": "Elevaciones Glúteo-Femoral",
...
/**
 * Translate an exercise name based on current language
 * Falls back to original name if translation not found
 */
export const translateExercise = (exerciseName, language = 'en') => {
    if (language === 'es' && exerciseTranslations[exerciseName]) {
        return exerciseTranslations[exerciseName];
    }
    return exerciseName;
};

/**
 * Translate muscle group combinations (like "Chest & Shoulders & Triceps")
 * Handles both individual muscle groups and combinations with "&"
 */
export const translateMuscleGroup = (muscleGroupName, language = 'en') => {
    if (language === 'en') {
        return muscleGroupName;
    }
    
    // Split by " & " and translate each part
    const parts = muscleGroupName.split(' & ');
    const translatedParts = parts.map(part => {
        const trimmedPart = part.trim();
        return exerciseTranslations[trimmedPart] || trimmedPart;
    });
    
    return translatedParts.join(' y ');
};