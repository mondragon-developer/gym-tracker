...
- **On content changes:** edit the doc here (plain .txt so Chatbase takes it as is), re-upload that file in Sources, and hit **Retrain agent** — keep `06-roadmap-*` in sync with the main `README.md` roadmap
