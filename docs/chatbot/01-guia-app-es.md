...
### Importar un plan del AI coach
Pide un plan a este asistente (por ejemplo "hazme un plan de 4 días"). La respuesta termina con un bloque `GYMPLAN v1`. Toca **Copiar** en la respuesta, abre **Importar plan** debajo de los días, pega y toca **Vista previa**. Cada línea recibe una etiqueta: **Biblioteca** (coincide con un ejercicio integrado, con demostración), **Personalizado** (se crea como ejercicio personalizado) o **Elegir** (elige el ejercicio correcto de una lista corta). Escoge **Reemplazar toda la semana** (los días que no están en el bloque pasan a Descanso) o **Combinar con la semana** (quedan como están), y por día **Reemplazar día**, **Añadir al día** u **Omitir**. **Aplicar a esta semana** pide un segundo toque; luego la semana se arma de una vez y aparece **Deshacer** abajo durante unos segundos. Funciona en la semana actual y en las semanas planificadas; los entrenadores tienen el mismo botón en el editor del cliente.
